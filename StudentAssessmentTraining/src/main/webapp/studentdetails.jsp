  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="studentdetails" class="active">
            <i class='bx bx-box' ></i>
  ...
  <section class="home-section">
    ...
    <div class="home-content">
      ...
      <div class="container mt-3">
        <a href="#" class="btn btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#addstudents" style="margin: 15px;">Add Student</a>
        <a href="viewstudents" class="btn btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#viewstudents" style="margin: 15px;">View Student</a>
      </div>
      <div id="accordion">
      <div id="addstudents" class="collapse w3-animate-top" data-bs-parent="#accordion">
        <form:form action="addstudent" method="post" modelAttribute="student" enctype="multipart/form-data" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin">
          <div class="mb-3 mt-3">
          ...
          <div class="mb-3 mt-3">
            ...
            <form:input class="form-control" id="cgpa" placeholder="Enter cgpa" path="cgpa" required="required"></form:input>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3 mt-3">
            ...
            <div class="hidden-fields">
            	<form:password path="password" hidden="hidden"  value="klu" ></form:password>
           		 <form:input path="facultymentor" hidden="hidden" value="null"></form:input>
           		<div class="mb-3 mt-3"> 
          ...
          <input type="submit" class="btn btn-primary mb-5" value="Add Student"/>
          </form:form>
          
        </div>
      <div id="viewstudents" class="collapse w3-animate-left" data-bs-parent="#accordion">
            ...
            <div class="sales-details">
               ...
               <table class="table table-hover">
					...
					<tr>
						...
						<td> 					
							<a href='<c:url value='deletestudentbyid?id=${s.id}'></c:url>'>Delete</a>&nbsp;&nbsp;
							<a href='<c:url value='viewstudentprofilebyid?id=${s.id}'></c:url>'>View</a>&nbsp;&nbsp;					
						</td>					
					</tr>
